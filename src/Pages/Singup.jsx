      ...
      <div className='h-[450px] w-full max-w-md rounded-lg bg-Blue100 p-6 shadow-lg'>
        ...
        <form className='space-y-4'>
          <label className='input input-bordered flex items-center gap-2'>
            ...
            <input type="text" className='flex-1 border-none outline-none' placeholder={t('singup.email')} />
          </label>
          <label className='input input-bordered flex items-center gap-2'>
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <input type="text" className='flex-1 border-none outline-none' placeholder={t('singup.username')} />
          </label>
          <label className='input input-bordered flex items-center gap-2'>
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <input type="password" className='flex-1 border-none outline-none'  placeholder={t('singup.password')} />
          </label>
